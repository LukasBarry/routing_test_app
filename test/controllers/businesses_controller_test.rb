...
class BusinessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post businesses_url, params: { business: { city: @business.city, name: @business.name, state: @business.state } }
    end
  ...
  test "should update business" do
    patch business_url(@business), params: { business: { city: @business.city, name: @business.name, state: @business.state } }
